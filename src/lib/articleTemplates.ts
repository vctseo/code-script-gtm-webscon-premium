// Article templates for WriteArticle page
export const ARTICLE_BAI1 = `<main class="styles_shopWrapper__953cK max-w-screen-xl"><!--$--><!--/$--><div class="my-5 bg-white p-4"><h1 class="text-2xl">Hướng dẫn đăng nhập</h1><div class="ant-divider css-5y1eqa css-var-_R_aivb_ ant-divider-horizontal" role="separator"></div><div class="styles_article__pCj5f"><div style="font-family: Inter,system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif; color: #1a1a1a; max-width: 860px; margin: 0 auto; -webkit-font-smoothing: antialiased;"><!-- HERO -->
...
<div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255,255,255,.18); border-radius: 999px; padding: 5px 14px; margin-bottom: 14px; font-size: 12px; font-weight: bold; color: #fff; letter-spacing: .06em; text-transform: uppercase;">🔑 PHANPHAN.VN Hướng Dẫn</div>
...
<div style="font-size: 14px; color: #fff; line-height: 1.65;"><strong>Chưa đăng nhập?</strong> Hệ thống có thể hiển thị mức giá cao hơn so với giá ưu đãi thực tế dành cho thành viên trên website PHANPHAN.VN.</div>
</div>
</div>
</div>
<!-- SO SÁNH GIÁ -->
...
<div style="font-size: 20px; font-weight: 900; color: #1a1a1a; margin-bottom: 10px;">Cách đăng nhập và mua hàng giá tốt tại PHANPHAN.VN</div>
...
<p style="font-size: 14px; line-height: 1.75; color: rgba(26,26,26,.70); margin: 0 0 14px;">Truy cập <strong>phanphan.vn</strong> → tìm banner đăng nhập hoặc nhấp vào <strong>icon người dùng</strong> ở góc trên bên phải để mở trang đăng nhập.</p>
<img style="width: 100%; border-radius: 12px; border: 1.5px solid rgba(102,186,50,.15); display: block;" src="https://img.lightshot.app/LX2FDAkFSaGdFPvGe-_V1g.png" alt="Giao diện đăng nhập PHANPHAN.VN"></div>
</div>
<!-- BƯỚC 2 -->
<div style="background: #fff; border-radius: 20px; border: 2px solid rgba(102,186,50,.22); box-shadow: 0 4px 6px rgba(0,0,0,.04),0 12px 32px rgba(102,186,50,.10); overflow: hidden; margin-bottom: 14px;">
<div style="background: linear-gradient(135deg,rgba(102,186,50,.12),rgba(79,152,35,.06)); padding: 16px 20px; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid rgba(102,186,50,.12);">
...
<img style="width: 100%; border-radius: 12px; border: 1.5px solid rgba(102,186,50,.15); display: block;" src="https://img.lightshot.app/wYzb5NDlTUKUfjyWKl7D_g.png" alt="Giao diện đồng ý Google PHANPHAN.VN"></div>
</div>
<!-- BƯỚC 3 -->
<div style="background: #fff; border-radius: 20px; border: 2px solid rgba(102,186,50,.22); box-shadow: 0 4px 6px rgba(0,0,0,.04),0 12px 32px rgba(102,186,50,.10); overflow: hidden; margin-bottom: 14px;">
...
<div style="font-size: 11px; font-weight: bold; letter-spacing: .08em; text-transform: uppercase; color: #4f9823; margin-bottom: 10px;">Mua hàng online giá rẻ tại PHANPHAN.VN</div>
<div style="font-size: 13.5px; line-height: 1.75; color: rgba(26,26,26,.68); margin-bottom: 14px;"><strong>phanphan.vn</strong> là hệ thống bán sỉ online với hàng ngàn sản phẩm <strong>Robot hút bụi, đồ gia dụng và thiết bị thông minh giá cực tốt</strong> dành riêng cho cộng tác viên và đại lý.</div>
...
<!-- FOOTER -->
<div style="text-align: center; padding: 16px 0; font-size: 12.5px; color: rgba(26,26,26,.38);">© PHANPHAN.VN · Hướng dẫn đăng nhập · Hotline: <a style="color: #4f9823; font-weight: bold; text-decoration: none;" href="tel:0784848484">07.84.84.84.84</a></div>
</div></div></div></main>`;

export const ARTICLE_BAI2 = `<div class="my-5 bg-white p-4"><h1 class="text-2xl">Giới thiệu về Phan Phan</h1><div class="ant-divider css-5y1eqa css-var-_R_aivb_ ant-divider-horizontal" role="separator"></div><div class="styles_article__pCj5f"><div style="font-family: Inter,system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif; color: #1a1a1a; max-width: 1100px; margin: 0 auto; -webkit-font-smoothing: antialiased; line-height: 1.6;"><!-- HERO -->
...
<div style="display: inline-flex; align-items: center; gap: 10px; padding: 8px 14px; border-radius: 999px; background: rgba(102,186,50,.1); border: 1px solid rgba(102,186,50,.16); margin-bottom: 18px;"><span style="font-size: 12px; font-weight: 800; letter-spacing: .08em; text-transform: uppercase; color: #4d9323;">PHANPHAN.VN GIỚI THIỆU</span></div>
...
<div style="font-size: 14px; line-height: 1.7; color: #33422b;">348 Quang Trung, Hà Đông, Hà Nội</div>
</div>
<div style="background: #fff; border: 1px solid rgba(102,186,50,.14); border-radius: 20px; padding: 16px; box-shadow: 0 6px 16px rgba(102,186,50,.05);">
...
<div style="font-size: 14px; line-height: 1.85; color: #5b6952;">PHANPHAN.VN vận hành theo mô hình mở, nơi người dùng có thể mua sắm và đồng thời tiếp cận cơ hội kinh doanh đa ngành hàng trên cùng một hệ thống.</div>
</div>
<div style="background: #fff; border-radius: 22px; border: 1px solid rgba(102,186,50,.14); box-shadow: 0 8px 22px rgba(102,186,50,.06); padding: 22px;">
...
<p style="margin: 0 0 16px; font-size: 14px; line-height: 1.85; color: #5b6952;">PHANPHAN.VN cung cấp nhiều nhóm sản phẩm khác nhau, giúp người dùng dễ dàng tìm kiếm và mua sắm trên cùng một website.</p>
...
<div style="background: linear-gradient(135deg,#f7fcf3,#fbfef9); border: 1px solid rgba(102,186,50,.12); border-radius: 18px; padding: 16px; font-size: 14px; line-height: 1.8; color: #5b6952;">Mô hình này giúp PHANPHAN.VN tối ưu chi phí vận hành và mang lại mức giá tốt hơn cho những người dùng thực sự có nhu cầu mua hàng.</div>
</div>
</div>
<!-- PAYMENT + SHIPPING -->
...
<div style="padding: 22px;">
<p style="margin: 0 0 14px; font-size: 14px; line-height: 1.85; color: #5b6952;">PHANPHAN.VN kết nối với các đơn vị vận chuyển như Viettel Post, GHN và các đối tác logistics khác.</p>
...
<div style="font-size: 28px; font-weight: 900; letter-spacing: -.02em; margin-bottom: 8px;">🚀 Cơ hội kinh doanh cùng PHANPHAN.VN</div>
<div style="font-size: 14px; line-height: 1.85; opacity: .96;">Bên cạnh mua sắm, PHANPHAN.VN cho phép người dùng kinh doanh theo mô hình <strong>Dropship</strong>, phù hợp với những ai muốn bắt đầu bán hàng linh hoạt mà không cần ôm hàng hay đầu tư vốn lớn.</div>
</div>
<!-- DROPSHIP -->
...
<div style="display: grid; gap: 10px;">
<div style="padding: 14px 16px; border-radius: 16px; border: 1px solid rgba(102,186,50,.12); background: #fff;">Lấy sản phẩm từ kho PHANPHAN.VN</div>
...
<div style="padding: 14px 16px; border-radius: 16px; border: 1px solid rgba(102,186,50,.12); background: #fff;">PHANPHAN.VN xử lý đóng gói và giao hàng</div>
</div>
...
<div style="padding: 22px;">
<p style="margin: 0 0 16px; font-size: 14px; line-height: 1.85; color: #5b6952;">PHANPHAN.VN hướng đến xây dựng một nền tảng phân phối và bán sỉ đa ngành, nơi người mua có giá tốt, người bán có cơ hội kinh doanh linh hoạt và toàn bộ hệ thống vận hành minh bạch, tự động.</p>
...
<div style="font-size: 28px; font-weight: 900; letter-spacing: -.02em; color: #fff; margin-bottom: 8px;">Khám phá PHANPHAN.VN ngay hôm nay</div>
...
<div style="font-size: 14px; color: #33422b;">phanphan.vn</div>
</div>
<div style="padding: 14px 16px; border-radius: 16px; background: #f7fcf3; border: 1px solid rgba(102,186,50,.12);">
...
<div style="font-size: 14px; color: #33422b;">348 Quang Trung, Hà Đông, Hà Nội</div>
</div>
<div style="padding: 14px 16px; border-radius: 16px; background: #f7fcf3; border: 1px solid rgba(102,186,50,.12);">
<div style="font-size: 12px; text-transform: uppercase; letter-spacing: .06em; color: #66ba32; font-weight: 800; margin-bottom: 6px;">Giờ làm việc</div>
...
<div style="text-align: center; color: #7d8b74; font-size: 12px; padding: 4px 0 8px;">© PHANPHAN.VN • Nền tảng phân phối và cơ hội kinh doanh dropship</div>
</div></div></div>`;

  export const POLICY_GIAO_HANG = `<div style="font-family: Inter,system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif; color: #1a1a1a; max-width: 860px; margin: 0 auto; -webkit-font-smoothing: antialiased;">
...
<div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap; position: relative;"><a style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 22px; border-radius: 14px; background: #fff; color: #c55a20; font-weight: 800; font-size: 14px; text-decoration: none; box-shadow: 0 4px 16px rgba(0,0,0,.12);" href="tel:0923796886">📞 0923.796.886</a></div>
  ...
  export const POLICY_THANH_TOAN = `<div style="font-family: Inter,system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif; color: #1a1a1a; max-width: 860px; margin: 0 auto; -webkit-font-smoothing: antialiased;">
<div style="border-radius: 22px; background: linear-gradient(135deg,#e97335 0%,#cf5d20 100%); padding: 32px 32px 28px; margin-bottom: 20px; box-shadow: 0 12px 40px rgba(233,115,53,.30); position: relative; overflow: hidden;">
<div style="position: absolute; top: -60px; right: -60px; width: 220px; height: 220px; border-radius: 50%; background: rgba(255,255,255,.07);">&nbsp;</div>
<div style="position: relative; z-index: 1;">
<div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255,255,255,.18); border-radius: 999px; padding: 5px 14px; margin-bottom: 14px; font-size: 12px; font-weight: bold; color: #fff; letter-spacing: .06em; text-transform: uppercase;">💳 Săn Đồ Ngon Chính Sách</div>
...
<div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap; position: relative;"><a style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 22px; border-radius: 14px; background: #fff; color: #c55a20; font-weight: 800; font-size: 14px; text-decoration: none; box-shadow: 0 4px 16px rgba(0,0,0,.12);" href="tel:0923796886">📞 0923.796.886</a></div>
  ...
  export const POLICY_BAO_MAT = `<div style="font-family: Inter,system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif; color: #1a1a1a; max-width: 860px; margin: 0 auto; -webkit-font-smoothing: antialiased;">
<div style="border-radius: 22px; background: linear-gradient(135deg,#e97335 0%,#cf5d20 100%); padding: 32px 32px 28px; margin-bottom: 20px; box-shadow: 0 12px 40px rgba(233,115,53,.30); position: relative; overflow: hidden;">
<div style="position: absolute; top: -60px; right: -60px; width: 220px; height: 220px; border-radius: 50%; background: rgba(255,255,255,.07);">&nbsp;</div>
<div style="position: relative; z-index: 1;">
<div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255,255,255,.18); border-radius: 999px; padding: 5px 14px; margin-bottom: 14px; font-size: 12px; font-weight: bold; color: #fff; letter-spacing: .06em; text-transform: uppercase;">🔒 Săn Đồ Ngon Chính Sách</div>
...
<div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap; position: relative;"><a style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 22px; border-radius: 14px; background: #fff; color: #c55a20; font-weight: 800; font-size: 14px; text-decoration: none; box-shadow: 0 4px 16px rgba(0,0,0,.12);" href="tel:0923796886">📞 0923.796.886</a></div>
  ...
  export const POLICY_DOI_TRA = `<div class="styles_article__pCj5f"><div style="font-family: Inter,system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif; color: #1a1a1a; max-width: 860px; margin: 0 auto; -webkit-font-smoothing: antialiased;">
<div style="border-radius: 22px; background: linear-gradient(135deg,#e97335 0%,#cf5d20 100%); padding: 32px 32px 28px; margin-bottom: 20px; box-shadow: 0 12px 40px rgba(233,115,53,.30); position: relative; overflow: hidden;">
<div style="position: absolute; top: -60px; right: -60px; width: 220px; height: 220px; border-radius: 50%; background: rgba(255,255,255,.07);">&nbsp;</div>
<div style="position: relative; z-index: 1;">
<div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255,255,255,.18); border-radius: 999px; padding: 5px 14px; margin-bottom: 14px; font-size: 12px; font-weight: bold; color: #fff; letter-spacing: .06em; text-transform: uppercase;">🔁 Săn Đồ Ngon Chính Sách</div>
